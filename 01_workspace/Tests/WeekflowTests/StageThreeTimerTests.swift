...
@Test func stageThreeTaskTimerUsesOneSharedSessionAndWritesBackActualTime() throws {
    ...
    #expect(elapsed == 3)
    #expect(updated.actualMinutes == initialActual + 3)
    #expect(updated.actualSeconds == entry.task.actualSeconds + 185)
...
@Test func stageThreeStartingAnotherTaskPausesThePreviousSharedSession() throws {
    ...
    #expect(updatedFirst.actualMinutes == first.task.actualMinutes + 1)
    #expect(updatedFirst.actualSeconds == first.task.actualSeconds + 75)
